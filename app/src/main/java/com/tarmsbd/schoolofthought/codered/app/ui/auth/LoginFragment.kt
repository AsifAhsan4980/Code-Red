...
private const val Map_Activity = "GoogleMapActivity"
private const val EMRGNC_Activity = "EmergencyActivity"
...
class LoginFragment : Fragment() {
                ...
                when {
                    task.isSuccessful -> {
                        ...
                        when (intentExtraText) {
                            ...
                            EMRGNC_Activity  -> {
                                startActivity(Intent(context, EmergencyActivity::class.java))
                                activity!!.finish()
                            }
                        }
                    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        reset.setOnClickListener {
            ...
            activity?.let{
                val intent = Intent (it, ResetActivity::class.java)
